            ...
            <div class="col-md-12">
                <div class="card card-user">
                    <div class="card-header">
                        <h5 class="card-title">Edit Job {{ $kry->nama}}</h5>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                        <form action="/admin/listjob/update" method="post">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="file" required="required" class="form-control" value="{{ $kry->file }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
